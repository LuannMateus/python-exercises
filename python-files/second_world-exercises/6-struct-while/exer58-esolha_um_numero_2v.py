...
print('Player: Why are you screaming?? I always win, so shut fuck up!')
...
while right == 0:
    ...
    if player < 0 or player > 10:
        ...
        if computer == player:
            ...
            print('{}-{}='.format(colors['white'], colors['red']) * 25)
            print(f'{colors["red"]}Computer: NOO, I AM THE COMPUTER')
            print(f'{colors["green"]}Player: HAHA I TOLD YOU, I ALWAYS WIN!!')
            ...
            print(f'{colors["red"]}Computer: HEYYYYYY, THIS IS CHEATERRRR!!!')
