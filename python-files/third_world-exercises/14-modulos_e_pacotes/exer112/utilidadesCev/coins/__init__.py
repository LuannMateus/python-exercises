...
def sumary(value, inc, dec, fort=False):
    print('\033[1;32m', end='')
    print('~~' * 20)
    print('Value Sumary'.center(38))
    print('~~' * 20)
    print(f'Price analyzed: {"R$":>8} {rep(value)}$')
    print(f'Half of price:  {"R$":>8} {half(value, fort)}$')
    print(f'Double price:   {"R$":>8} {double(value, fort)}$')
    print(f'{inc}% increase:{"R$":>11} {increase(value, inc, fort)}$')
    print(f'{dec}% decrease:{"R$":>11} {decrease(value, dec, fort)}$')
    print('~~' * 20)
    print('\033[m', end='')
